...
export default function HeroSection() {
  ...
  <span className="text-gradient-warm">Crafted for Cafés</span>
  <br />
  <span className="text-cream">Designed for Growth</span>
</h1>

<p className="hero-animate text-cream/70 text-base sm:text-lg md:text-xl max-w-2xl mb-8 opacity-0">
  A seamless digital experience that helps cafés operate effortlessly, serve faster,  
  and create unforgettable customer moments.
</p>
          ...
          {kpis.map((kpi) => (
            ...
            >
              ...
              <div className="text-left">
                <div className="text-3xl font-bold text-caramel">{kpi.value}</div>
